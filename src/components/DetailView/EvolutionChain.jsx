...
export function EvolutionChain({ pokemonId }) {
          ...
          <>
            ...
            <div className="mx-8 flex flex-col items-center justify-center">
              ...
              {chain.evolvesTo[0]?.evolutionDetails && (
                <div className="bg-gray-700/80 rounded-lg px-3 py-1.5 text-white text-sm mb-2">
  ...
  return (
    <div className="bg-gray-800 bg-[linear-gradient(45deg,transparent_25%,rgba(0,0,0,0.1)_25%,rgba(0,0,0,0.1)_50%,transparent_50%,transparent_75%,rgba(0,0,0,0.1)_75%)] bg-[length:10px_10px] rounded-xl p-8">
